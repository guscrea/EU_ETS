...
ets_path = "/Users/chrisrea/Professional/Research/Emissions_Trading/EU_ETS_Special_Issue_Culture_Practice_and_Europeanization/EU_ETS_Auctions_Revenues/EU_ETS_Weekly_price_2008_04_to_2019_01.csv"
ets_price = read.csv(ets_path, header = TRUE)

auctions_path = "/Users/chrisrea/Professional/Research/Emissions_Trading/EU_ETS_Special_Issue_Culture_Practice_and_Europeanization/EU_ETS_Auctions_Revenues/EU_ETS_Auctions_Revenues_by_2013_to_Jan2019.csv"
...
ggplot(ets_price,
  ...
  annotate("text", x = as.Date("2012-04-01"),
           y = 28.8, label = "Phase II",
           colour = "#8E8E8E") +
  annotate("text", x = as.Date("2013-10-01"),
           y = 28.8, label = "Phase III",
           colour = "#8E8E8E") +
